...
export function Hero() {
  ...
  return (
    <>
      <LoadingAnimation isLoading={isLoading} onFinished={handleLoadingFinished} />
                    ...
                    <div className="absolute inset-0 grid grid-cols-1 grid-rows-1 gap-1 p-2">
                      <div className="relative w-full h-full">
                        ...
                        <div className="absolute bottom-0 right-0 w-1/2 h-full bg-white rounded-lg shadow-lg overflow-hidden transform rotate-6">
                          <div className="absolute -top-3 -left-3 w-8 h-8 bg-yellow-300 rounded-full flex items-center justify-center transform rotate-12 z-10">
                            <span className="text-sm">★</span>
                          </div>
                          <div className="absolute top-1/4 -right-3 w-7 h-7 bg-primary rounded-full flex items-center justify-center transform -rotate-12 z-10">
